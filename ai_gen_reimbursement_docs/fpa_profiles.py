...
MULTI_UI_CORE_RULES = "请在 fpa_config.yaml 的 core_rules.multi_ui_cr 配置 multi_ui 核心口径。"
...
def _profile_from_kind(profile_name: str, kind: str) -> CustomRulesProfile:
    ...
    if kind == "multi_ui":
        return MultiUiProfile(name=profile_name)
