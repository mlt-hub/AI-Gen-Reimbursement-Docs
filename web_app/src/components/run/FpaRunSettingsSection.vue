<template>
  <section class="surface rounded-lg p-4">
    <div class="mb-4 border-b border-[var(--color-rule)] pb-3">
      <p class="text-xs font-semibold text-[var(--color-ink-soft)]">低频任务设置</p>
      <h3 class="mt-1 text-base font-bold text-[var(--color-ink)]">FPA 策略与运行参数</h3>
    </div>
